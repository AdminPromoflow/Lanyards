<!-- Main container for the lanyard preview section with ID "two-side-30mm" and class "two-side-25mm" -->
<div id="two-side-30mm" class="two-side-25mm">

  <!-- Inner container holding the lanyard design -->
  <div class="container-one-side-25mm">

    <!-- Section to draw the lanyard with two ends -->
    <div class="draw-lanyard-two-ends">

      <!-- Back clip section for the two-sided 30mm lanyard -->
      ...
      <div class="two-ends-left-30mm backgroundColour">
        <div class="draw-ts-normal-left-30mm text-container draw-ts-30mm"></div>
      </div>

      <!-- Right side of the lanyard with background color -->
      <div class="two-ends-right-30mm backgroundColour">
        <div class="draw-ts-normal-right-30mm text-container draw-ts-30mm"></div>
      </div>

    </div>

    <!-- Left side attachment section -->
    ...
    <!-- Right side attachment section -->
    <div class="attachmentThing ts-attachment-30mm-r">
      <img src="../../views/assets/img/global/customize-lanyard/sections/attachment/quick-release-black.png" alt="">
    </div>

    <!-- Left side clip section for the two-sided lanyard -->
    ...
    <!-- Right side clip section for the two-sided lanyard -->
